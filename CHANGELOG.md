...
## [2.8.14](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/compare/v2.10.1...v2.8.14) (2026-08-26)
...
* hoist the batch count out of the autolinker loop condition ([76099be](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/76099be2dd4e8ecff22f00cbde164915f8c0277b))
* make the PHPCS gate name the file and line it failed on ([1b6a1df](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/1b6a1dfc26a09ba8c1e1020b95ab1be735400688))
* make the release build work — version from tag, and unbreak the build ([#149](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/issues/149)) ([5b15aa3](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/5b15aa390f47bb45230757e007b07c29de5744be))
* page the autolinker term query instead of loading every entry ([2a729bb](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/2a729bb8fdd53ec688551313b20b202eb5a8277a))
...
* preserve docblock alignment when stamping [@version](https://github.com/version) ([4f407ff](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/4f407ff08957818b7cceac999686a7f572af4cd2))
...
* tag only — main is protected and the release does not need a commit ([cffa156](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/cffa1569637eb346ea2fb7b2099a9706945220f7))
...
* record the two release-pipeline traps this cycle hit ([#114](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/issues/114)) ([75b7071](https://github.com/Starisian-Technologies/sparxstar-3iatlas-dictionary/commit/75b7071088fcee27ce01966c292b4d83bc84027c))
