...
final class Sparxstar3IAtlasDictionary {
    ...
    private function sparxIAtlas_register_hooks(): void {
        add_action( 'wp_enqueue_scripts', array( $this, 'sparxIAtlas_enqueue_app' ) );
        add_action( 'wp_footer', array( $this, 'sparxIAtlas_mount_div' ) );
    }

    public function sparxIAtlas_enqueue_app() {
        wp_enqueue_script(
            'aiwa-dictionary-app',
            SPARX_3IATLAS_URL . 'assets/js/app.min.js',
            array(),
            '1.0.0',
            true
        );
        ...
        wp_enqueue_style(
            ...
            SPARX_3IATLAS_URL . 'assets/css/app.min.css',
            array(),
            '1.0.0'
        );
    }
    ...
    private function sparxIAtlas_load_textdomain(): void {
        load_plugin_textdomain( 'Sparxstar3IAtlasDictionary', false, dirname( plugin_basename( SPARX_3IATLAS_PATH ) ) . '/languages' );
    }
